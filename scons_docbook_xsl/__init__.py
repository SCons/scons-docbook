...
db_xsl_folder = pkg_resources.resource_filename('scons_docboox_xsl', 'docbook-xsl-1.76.1')

# Local folder for the Docbook slides package
db_slides_folder = pkg_resources.resource_filename('scons_docboox_xsl', 'docbook-slides-3.4.0')
